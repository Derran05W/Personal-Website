...
- [~] **Phase 36 — Occlusion v2: dithered fade for batched/instanced geometry + camera anti-clip** — 2026-07-26: first run stopped deliberately by the user mid-implementation (21 dirty files: occlusionFade/cameraClipIndex/CityPackBatched/CityDress/cameraRig et al., uncommitted; phase-36-plan.md exists) — RESUME from the plan + tree, don't restart
